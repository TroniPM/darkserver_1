...
int CMailBox::ConnectServer(int epfd)
{
    ...
    EV_SET(&ev[0], m_fd, EVFILT_READ, EV_ADD|EV_ENABLE, 0, 0, (void*)(intptr_t)m_fd);
    EV_SET(&ev[1], m_fd, EVFILT_WRITE, EV_ADD|EV_ENABLE, 0, 0, (void*)(intptr_t)m_fd);

    if(kevent(epfd, ev, 2, NULL, 0, NULL) == -1)
    {
